...
class OhHellGame extends Component {
  ...
  GetOneCardFromDeck = () =>{
    // return a random num 52 max or return count of cards if no card left
    ...
    MoveDeck = (deck) =>{
      ...
      GetCardCount = (deck) =>{
        ...
        StartNewGame = () =>{
          ...
          // need to add 2 players count = 13 
        ...
        DoOneMove = () =>{
            ...
            // 2. Banks is NO empty. Need to put three cards + one
              ...
              let count;
                ...
                TableCtx.fillStyle = "rgb(53, 101, 77)";
...
render = () => {
    ...
    switch (this.state.MoveState) {
        case "EndMove":
        // Someone will won! Let's check it
        let BankCardCount = this.GetCardCount(this.state.PlayerBank);
        let PlayerCard = this.state.PlayerBank[BankCardCount - 1] % 13;
        let AICard = this.state.AIBank[BankCardCount - 1] % 13;
        if (PlayerCard > AICard) {
    ...
    return(
        <div className="CardTable">
            ...
            <button className="OhHellGameButton HeaderText" onClick={this.StartNewGame}>
                {" "}
                Oh Hell{" "}
            </button>
